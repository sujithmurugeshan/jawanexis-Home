            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-[1280px] mx-auto px-4">
              {teamMembers.map((member) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 px-6 py-5 transition-transform duration-300 ease-out translate-y-full group-hover:translate-y-0 z-20 text-left" style={{ background: "linear-gradient(180deg, #19d950 0%, #0b8a32 100%)" }}>
