...
const teamProfiles = {
  "soorya-jawahar": {
    ...
    quote: "Empowering learners with skills, confidence, and opportunities to build successful careers.",
    founderMessage: {
  ...
  "anisha-riya": {
    ...
    quote: "The right guidance, practical exposure, and industry knowledge can transform aspiring learners into confident HR professionals."
  },

  "nitinchand-saravanan": {
    slug: "nitinchand-saravanan",
    name: "Nitinchand Saravanan",
    role: "Tech Advisor",
    photo: nithinPhoto,
    about: [
    ...
    responsibilities: [
      ...
      "Supporting placement-focused technical skill development"
    ],
    testimonials: [
